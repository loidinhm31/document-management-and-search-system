package com.sdms.auth.services.impl;

import com.sdms.auth.constants.AuditActions;
import com.sdms.auth.constants.AuditStatus;
import com.sdms.auth.dtos.UserDto;
import com.sdms.auth.dtos.request.*;
import com.sdms.auth.entities.RefreshToken;
import com.sdms.auth.enums.AppRole;
import com.sdms.auth.exceptions.InvalidRequestException;
import com.sdms.auth.exceptions.ResourceNotFoundException;
import com.sdms.auth.mappers.UserMapper;
import com.sdms.auth.entities.PasswordResetToken;
import com.sdms.auth.entities.Role;
import com.sdms.auth.entities.User;
import com.sdms.auth.repositories.PasswordResetTokenRepository;
import com.sdms.auth.repositories.RoleRepository;
import com.sdms.auth.repositories.UserRepository;
import com.sdms.auth.security.jwt.JwtUtils;
import com.sdms.auth.security.request.Verify2FARequest;
import com.sdms.auth.security.response.TokenResponse;
import com.sdms.auth.security.response.UserInfoResponse;
import com.sdms.auth.security.services.CustomUserDetails;
import com.sdms.auth.services.AdminService;
import com.sdms.auth.services.TotpService;
import com.sdms.auth.services.UserService;
import com.sdms.auth.utils.SecurityUtils;
